...
const STRINGS = {
  fa: {
    ...
    createdAtLabel: 'ساخته شده',
    logsBtn: 'بازه‌های زمانی',
    logStart: 'شروع',
    logEnd: 'پایان',
    logRunning: 'در حال اجرا',
    logDur: 'مدت',
    addInterval: '+ بازه دستی',
    ...
    providerServer: 'سرور اختصاصی (Google)',
    ...
    connectServerBtn: 'ورود با Google',
  ...
  en: {
    ...
    providerServer: 'Custom Server (Google)',
    providerOneDrive: 'OneDrive',
    ...
    connectServerBtn: 'Login with Google',
